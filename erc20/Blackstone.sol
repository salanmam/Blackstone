...
/**
* @title Blackstone Token
**/
contract BlackstoneToken is ERC20, Pauseable {
    ...
    string public constant name = "Blackstone";
    string public constant symbol = "Blackstone";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY =   500000000 * (10 ** uint256(decimals));
    
    function BlackstoneToken() public {
        owner = msg.sender;
